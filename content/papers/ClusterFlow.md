+++
title = "Cluster Flow: an Advanced Concept for Ensemble-Enabling, Interactive Clustering"
slug = "cluster-flow"  # Use only lowercase letters, numbers, and hyphens
date = 2021-01-01T12:00:00+02:00
draft = false

year = 2021
authors = ["Sandra Obermeier", "Anna Beer", "Florian Wahl", "Thomas Seidl"]
venue = "BTW 2021 (Gesellschaft für Informatik, Bonn)"
summary = "Short summary of the paper."

tags = ["clustering"]  # Add as needed

pdf = "paper.pdf"  # Place PDF in static/papers/
external_pdf = "https://dl.gi.de/items/cbba5b1d-3442-4255-b96e-775b6bf4cbcc"  # Optional external link, if none : remove param
