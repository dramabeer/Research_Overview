+++
title = "Clustering Trend Data Time-Series through Segmentation of FFT-decomposed Signal Constituents."
slug = "clustering-trend-data"  # Use only lowercase letters, numbers, and hyphens
date = 2019-01-01T12:00:00+02:00
draft = false

year = 2019
authors = ["Daniyal Kazempour", "Anna Beer", "Oliver Schrüfer", "Thomas Seidl"]
venue = "LWDA"
summary = "Short summary of the paper."

tags = ["clustering", "FFT"]  # Add as needed

pdf = "paper.pdf"  # Place PDF in static/papers/
external_pdf = "https://ceur-ws.org/Vol-2454/paper_64.pdf"  # Optional external link, if none : remove param
