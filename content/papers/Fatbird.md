...
slug = "fatbird"  # Use only lowercase letters, numbers, and hyphens
date = 2018-10-29T12:00:00+02:00
draft = false

year = 2018
authors = ["Daniyal Kazempour", "Anna Beer", "Friederike Herzog", "Daniel Kaltenthaler", "Johannes-Y Lohrer", "Thomas Seidl"]
venue = "2018 IEEE 14th International Conference on e-Science (e-Science)"
summary = "Short summary of the paper."

tags = ["e-science"]  # Add as needed

pdf = "paper.pdf"  # Place PDF in static/papers/
external_pdf = "https://ieeexplore.ieee.org/abstract/document/8588642"  # Optional external link, if none : remove param
