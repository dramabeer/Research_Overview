+++
title = "Compound Segmentation via Clustering on Mol2Vec-based Embeddings"
slug = "compound-segmentation"  # Use only lowercase letters, numbers, and hyphens
date = 2021-09-20T12:00:00+02:00
draft = false

year = 2021
authors = ["Daniyal Kazempour", "Anna Beer", "Melanie Oelker", "Peer Kröger", "Thomas Seidl"]
venue = "2021 IEEE 17th International Conference on eScience (eScience)"
summary = "Short summary of the paper."

tags = ["clustering", "embeddings"]  # Add as needed

pdf = "paper.pdf"  # Place PDF in static/papers/
external_pdf = "https://ieeexplore.ieee.org/abstract/document/9582401"  # Optional external link, if none : remove param
